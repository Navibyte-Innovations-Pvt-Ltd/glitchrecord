...
Pairing rules: text.color contrasts color2 (text sits in the BRIGHT end of the gradient); glow.color is the LOGO halo — use the accent hex, never the dark base. LIGHT palettes (WARM SAND, IVORY) set background.glow ≤0.15 and vignette ≤0.2; DARK palettes set glow 0.2–0.35, vignette 0.28–0.4. The background glow HUE is auto-derived from color2 — you only set its STRENGTH.
