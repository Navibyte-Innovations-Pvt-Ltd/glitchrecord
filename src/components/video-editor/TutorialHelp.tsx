import { ArrowRight, Bug, Question as HelpCircle, Keyboard, Scissors, GearSix as Settings2 } from "@phosphor-icons/react";
...
/** Opens the in-window Report Bug sheet (InlineReport), which files into the team's glitchgrab repo. */
...
export function ReportBugButton() {
	...
	return (
		<Button
			...
			title={t("feedback.reportIssue", "Report a bug")}
			aria-label={t("feedback.reportIssue", "Report a bug")}
		>
